...
class SolarEnergyTrainingDataset(Dataset):
    def __init__(self, trainset_config):
        ettm1_path = "/data/f.caldas/csdi/datasets/Solar_Energy/y_train.npy"
        if os.path.exists(ettm1_path):
            print('Importing from data server...')
            training_data = np.load(ettm1_path)
        else:
...
class SolarEnergyValidationDataset(Dataset):
    def __init__(self, trainset_config):
        ettm1_path = "/data/f.caldas/csdi/datasets/Solar_Energy/y_val.npy"
        if os.path.exists(ettm1_path):
            print('Importing from data server...')
            training_data = np.load(ettm1_path)
        else:
...
class SolarEnergyTestDataset(Dataset):
    def __init__(self, trainset_config):
        ettm1_path = "/data/f.caldas/csdi/datasets/Solar_Energy/y_test.npy"
        if os.path.exists(ettm1_path):
            print('Importing from data server...')
            training_data = np.load(ettm1_path)
        else:
...
class TempRainTrainingDataset(Dataset):
    def __init__(self, trainset_config):
        ettm1_path = "/data/f.caldas/csdi/datasets/TempRain/y_train.npy"
        if os.path.exists(ettm1_path):
            print('Importing from data server...')
            training_data = np.load(ettm1_path)
        else:
...
class TempRainValidationDataset(Dataset):
    def __init__(self, trainset_config):
        ettm1_path = "/data/f.caldas/csdi/datasets/TempRain/y_val.npy"
        if os.path.exists(ettm1_path):
            print('Importing from data server...')
            training_data = np.load(ettm1_path)
        else:
...
class TempRainTestDataset(Dataset):
    def __init__(self, trainset_config):
        ettm1_path = "/data/f.caldas/csdi/datasets/TempRain/y_test.npy"
        if os.path.exists(ettm1_path):
            print('Importing from data server...')
            training_data = np.load(ettm1_path)
        else:
...
class Synth1TrainingDataset(Dataset):
    def __init__(self, trainset_config):
        ettm1_path = "/data/f.caldas/csdi/datasets/Synth1/y_train.npy"
        if os.path.exists(ettm1_path):
            print('Importing from data server...')
            training_data = np.load(ettm1_path)
        else:
...
class Synth1ValidationDataset(Dataset):
    def __init__(self, trainset_config):
        ettm1_path = "/data/f.caldas/csdi/datasets/Synth1/y_val.npy"
        if os.path.exists(ettm1_path):
            print('Importing from data server...')
            training_data = np.load(ettm1_path)
        else:
...
class Synth1TestDataset(Dataset):
    def __init__(self, trainset_config):
        ettm1_path = "/data/f.caldas/csdi/datasets/Synth1/y_test.npy"
        if os.path.exists(ettm1_path):
            print('Importing from data server...')
            training_data = np.load(ettm1_path)
        else:
...
class SolarEnergyTestDataset(Dataset):
    def __init__(self, trainset_config):
        ettm1_path = "/data/f.caldas/csdi/datasets/solar-energy/y_test.npy"
        if os.path.exists(ettm1_path):
            print('Importing from data server...')
            training_data = np.load(ettm1_path)
        else:
...
class SolarEnergyTrainingDataset(Dataset):
    def __init__(self, trainset_config):
        ettm1_path = "/data/f.caldas/csdi/datasets/solar-energy/y_train.npy"
        if os.path.exists(ettm1_path):
            print('Importing from data server...')
            training_data = np.load(ettm1_path)
        else:
...
class MujocoTestDataset(Dataset):
    def __init__(self, testset_config):
        dat_path = "/data/f.caldas/csdi/datasets/Mujoco/test_mujoco.npy"
        if os.path.exists(dat_path):
...
class ETTm1TestDataset(Dataset):
    def __init__(self, testset_config):
        ettm1_test_path = "/data/f.caldas/csdi/datasets/ETTm1/test_ettm1_1056.npy"
...
class ElectricityTestDataset(Dataset):
    def __init__(self, testset_config):
        dat_path = "/data/f.caldas/csdi/datasets/Electricity/test_electricity.npy"
        if os.path.exists(dat_path):
            print('Importing test data from data server...')
            test_data = np.load(dat_path)
        else:
...
class PTBXLTestDataset(Dataset):
    def __init__(self, testset_config):
        dat_path = "/data/f.caldas/csdi/datasets/PTB-XL-1000/test_ptbxl_1000.npy"
        if os.path.exists(dat_path):
            print('Importing test data from data server...')
            test_data = np.load(dat_path)
        else:
